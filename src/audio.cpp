...
void playTableBounceSFX(){
    std::string tableSFXdir = "resources/sfx/table." + std::to_string(random(0, 2)) + ".wav";
    playSound(tableSFXdir.c_str(), SDL_MIX_MAXVOLUME);
}

void playPaddleBounceSFX(){
    std::string paddleSFXdir = "resources/sfx/paddle." + std::to_string(random(0, 2)) + ".wav";
    playSound(paddleSFXdir.c_str(), SDL_MIX_MAXVOLUME);
}

void playSFX(std::string input){
    playSound(input.c_str(), SDL_MIX_MAXVOLUME);
}
